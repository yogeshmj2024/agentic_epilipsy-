...
This project is licensed under the MIT License. In compliance with publishing policies, AI coding tools were utilized solely for code formatting and syntax verification; all scientific concepts, dataset curation, model architectures, and statistical evaluations were independently executed by the authors.
