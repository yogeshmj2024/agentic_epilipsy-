...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/graphepirec_architecture.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/graphepirec_subgraph.png}
...
\begin{enumerate}[leftmargin=*]
    ...
    \item \textbf{TransE Knowledge Graph Embedding} \cite{bordes2013translating}: Translational KG embedding model ($d=128$, L2 distance metric) trained on the structured multi-relational EHR graph.
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\textwidth]{figures/graphepirec_performance.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/graphepirec_safety_ablation.png}
